...
from App_Proyecto_final.views import combo_cotillon, combo_cotillon_formulario, copetin, copetin_formulario, disfraz, disfraz_formulario, golosinas, golosinas_formulario, inicio, agregar_golosinas
